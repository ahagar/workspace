...
Int_t slcio2appTree(UInt_t nFirstJob, UInt_t nLastJob, const char * fn, const char * rfn)
{
	...
	bhabha.Branch("bfid0", &(vl.bfid0), "bfid0");
	bhabha.Branch("bfid50", &(vl.bfid50), "bfid50");
			...
			//std::cout << colNames[i] << endl;
				...
				*/
					...
					if (particlePDG  == 11){
						...
						yeminus = yaxis;
						zeminus = zaxis;
						pdgeminus = particlePDG;
						thetaeminus = temp.Theta();
					}
					if (particlePDG  == -11){
						xeplus = xaxis;
						yeplus = yaxis;
						zeplus = zaxis;
						pdgeplus = particlePDG;
						thetaeplus = temp.Theta();
					}
				...
				if (cestice.size() == 2) {
					broj2Dogadjaja++;
				//	if (xeplus>  0 || xeminus > 0 ) up++;
				//	if (xeplus < 0 || xeminus < 0) down++;
					}
				if (cestice50.size() == 2) {
					broj2Dogadjaja50++;
					if (xeminus > 0 )up50++;
				...
				if (cestice100.size() == 2) {
					broj2Dogadjaja100++;
					if (z>0 && xaxis>0 ) up100++;
					if (z>0 && xaxis<0 ) down100++;
					}
				if (cestice110.size() == 2) {
					broj2Dogadjaja110++;
					if (z>0 && xaxis>0 ) up110++;
					if (z>0 && xaxis<0 ) down110++;
					}
				if (cestice120.size() == 2) {
					broj2Dogadjaja120++;
					if (z>0 && xaxis>0 ) up120++;
					if (z>0 && xaxis<0 ) down120++;
					}
				if (cestice130.size() == 2) {
					broj2Dogadjaja130++;
					if (z>0 && xaxis>0 ) up130++;
					if (z>0 && xaxis<0 ) down130++;
					}
				if (cestice140.size() == 2) {
					broj2Dogadjaja140++;
					if (z>0 && xaxis>0 ) up140++;
					if (z>0 && xaxis<0 ) down140++;
					}
				if (cestice150.size() == 2) {
					broj2Dogadjaja150++;
					if (z>0 && xaxis>0 ) up150++;
					if (z>0 && xaxis<0 ) down150++;
					}
				if (cestice160.size() == 2) {
					broj2Dogadjaja160++;
					if (z>0 && xaxis>0 ) up160++;
					if (z>0 && xaxis<0 ) down160++;
					}
				if (cestice170.size() == 2) {
					broj2Dogadjaja170++;
					if (z>0 && xaxis>0 ) up170++;
					if (z>0 && xaxis<0 ) down170++;
					}
				if (cestice180.size() == 2) {
					broj2Dogadjaja180++;
					if (z>0 && xaxis>0 ) up180++;
					if (z>0 && xaxis<0 ) down180++;
					}
				if (cestice190.size() == 2) {
					broj2Dogadjaja190++;
					if (z>0 && xaxis>0 ) up190++;
					if (z>0 && xaxis<0 ) down190++;
					}
				if (cestice200.size() == 2) {
					broj2Dogadjaja200++;
					if (z>0 && xaxis>0 ) up200++;
					if (z>0 && xaxis<0 ) down200++;
					}
				if (cestice210.size() == 2) {
					broj2Dogadjaja210++;
					if (z>0 && xaxis>0 ) up210++;
					if (z>0 && xaxis<0 ) down210++;
					}
				if (cestice220.size() == 2) {
					broj2Dogadjaja220++;
					if (z>0 && xaxis>0 ) up220++;
					if (z>0 && xaxis<0 ) down220++;
					}
				if (cestice230.size() == 2) {
					broj2Dogadjaja230++;
					if (z>0 && xaxis>0 ) up230++;
					if (z>0 && xaxis<0 ) down230++;
					}
				if (cestice240.size() == 2) {
					broj2Dogadjaja240++;
					if (z>0 && xaxis>0 ) up240++;
					if (z>0 && xaxis<0 ) down240++;
					}
				if (cestice250.size() == 2) {
					broj2Dogadjaja250++;
					if (z>0 && xaxis>0 ) up250++;
					if (z>0 && xaxis<0 ) down250++;
					}
