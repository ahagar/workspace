...
//Two photons + invM
	...
	//two  Photons with pt>10, upisuje se za sve evente
		...
		TH1F ECE ("ECE", "ECE; E_{ecal} (GeV)", 3000, 0, 3000);
	...
	for(UInt_t iJob=nFirstJob; iJob<=nLastJob; iJob++)
	{
		...
		/*	EVENT::StringVec sv;
			evt->getParameters().getStringVals("Process", sv);
			...
			//cout << "ukupna enerrgija u kalorimetrima je : "<< eCalSum << ", " << eCalBarel << ", "<< eCalEndCap <<",  "<< eCalOther<<endl;
