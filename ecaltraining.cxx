...
//Two photons + invM
	...
	eventList.Branch("CandidateM", &(vl.CandidateInvariantM), "invM");
	eventList.Branch("CandidateE", &(vl.CandidateEnergy), "CanE");
	eventList.Branch("CandidateTheta", &(vl.CandidateTheta), "CanTHeta");
	eventList.Branch("CandidatePt", &(vl.CandidatePt), "CanPt");
	eventList.Branch("CandidatePhi", &(vl.CandidatePhi), "CanPhi");
	eventList.Branch("photonsPerEvent", &(vl.NumberPhotonsbyEvent), "photonsPerEvent");
	eventList.Branch("cosHelAngle", &(vl.cosHelAngle), "cos_hel_angle");
	...
	eventList.Branch("pLCandidatePhoton1", &(vl.pLCandidatePhotons1), "pLCandidatePhotons1");
	eventList.Branch("pLCandidatePhoton2", &(vl.pLCandidatePhotons2), "pLCandidatePhotons2");
	eventList.Branch("thetaCandidatePhoton1", &(vl.thetaCandidatePhotons1), "thetaCandidatePhotons1");
	eventList.Branch("thetaCandidatePhoton2", &(vl.thetaCandidatePhotons2), "thetaCandidatePhotons2");
	eventList.Branch("pTCandidatePhoton1", &(vl.pTCandidatePhotons1), "pTCandidatePhotons1");
	eventList.Branch("pTCandidatePhoton2", &(vl.pTCandidatePhotons2), "pTCandidatePhotons2");
...
Int_t main(int argc, char* argv[])
{
	...
	TString rfName = "ecaltraining_pt15.root";
