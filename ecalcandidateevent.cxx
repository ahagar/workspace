...
const Double_t coneAngle = 0.5;//2.5;		   //ugao konusa
...
Int_t slcio2appTree(UInt_t nFirstJob, UInt_t nLastJob, const char * fn, const char * rfn)
{
	...
	TH1F histoconeEnergyFilter ("ConeEnergyFilter", "ConeEnergyFilter; E_{cone} (GeV)", 20, 0, 20);
	...
	TH1F histoconeEnergyfor2Photons ("ConeEnergy2Photons", "ConeEnergy; E_{cone} (GeV)", 500, 0, 500);
