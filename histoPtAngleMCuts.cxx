...
const double minInvMass = 100;
const double maxInvMass = 150;
...
Int_t slcio2appTree(UInt_t nFirstJob, UInt_t nLastJob, const char * fn, const char * rfn)
{
	...
	ofstream results ;
	results.open("pTAngleMCuts.txt", ios_base::out | ios_base::app);
...
//	c1.GetPad(1)->SetLogy();
	histoPtMax.Draw();
	c1.Print("pTAngleMCutshistoMaxPt.eps");
	...
	//c2.GetPad(1)->SetLogy();
	histoPt2Max.Draw();
	c2.Print("pTAngleMCutshisto2ndMax.eps");
	...
	c3.GetPad(1)->SetLogy();
	histoPtMaxZoom.Draw();
	c3.Print("pTAngleMCutshistoMaxPtZoom.eps");
	...
	c4.Print("pTAngleMCutshisto2ndMaxZoom.eps");
	...
	c5.GetPad(1)->SetLogy();
	histoPhotonPt.Draw();
	c5.Print("pTAngleMCutsPhotonPt.eps");
	...
	c6.Print("pTAngleMCutsPhotonTheta.eps");
	...
	c7.GetPad(1)->SetLogy();
	histoPhotonTg.Draw();
	c7.Print("pTAngleMCutsTangens.eps");
	...
	c8.Print("pTAngleMCutsThetaStar.eps");
...
Int_t main(int argc, char* argv[])
{
	...
	TString rfName = "histoPtAngleMCuts.root";
