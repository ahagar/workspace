...
*/
			...
			/////TLorentzVector el_in;
			/////TLorentzVector poz_in;
			/////TLorentzVector el_out;
			/////TLorentzVector poz_out;
			/////vector <TLorentzVector> v1_in, v2_out;
...
*/
						if (abs(PDG_cestica) <7 &&  abs(PDG_cestica)>0)
						{
							nqvarkova++;
