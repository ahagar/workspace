...
Int_t slcio2appTree(UInt_t nFirstJob, UInt_t nLastJob, const char * fn, const char * rfn)
{
	...
	TH1F histoCandidateMTest ("CandidateInvariantMTest", "CandidateInvariantM; M_{#gamma#gamma} (GeV)", 3000, 0, 3000);
	...
	//ecall energy preslection
	TH1F histoECall_ecal_preselection ("ECall_ecal_preselection", "ECall; E_{ecal} (GeV)", 3000, 0, 3000);
	TH1F histoHCall_ecal_preselection ("HCall_ecal_preselection", "HCall; E_{hcal} (GeV)", 3000, 0, 3000);
	TH1F histoTotalCall_ecal_preselection  ("EnergyCalorimeter_ecal_preselection ", "EnergyCalorimeter; E_{calorimeter} (GeV)", 300, 0, 3000);
	TH1F histoCallRatio_ecal_preselection  ("calRatio_ecal_preselection ", "calRatio ", 100, 0, 1);
	TH1F histoECallEvt_ecal_preselection  ("ECallEvt_ecal_preselection ", "ECallEvt; E_{ecal} (GeV)", 1500, 0, 3000);
	TH1F histoHCallEvt_ecal_preselection  ("HCallEvt_ecal_preselection ", "HCallEvt; E_{hcal} (GeV)", 1500, 0, 3000);
	TH1F histoTotalCallEvt_ecal_preselection  ("EnergyCalorimeterEvt_ecal_preselection ", "EnergyCalorimeterEvt; E_{calorimeter} (GeV)", 300, 0, 3000);
	TH1F histoCallRatioEvt_ecal_preselection  ("calRatioEvt_ecal_preselection ", "calRatioEvt ", 100, 0, 1);
	TH1F histoCandidateM_ecal_preselection ("CandidateInvariantM_ecal_preselection ", "CandidateInvariantM; M_{#gamma#gamma} (GeV)", 1000, 0, 1000);
	TH1F histoCandidatePt_ecal_preselection  ("CandidatePt_ecal_preselection ", "CandidatePt; Pt_{#gamma#gamma} (GeV)", 1500, 0, 1500);
	TH1F histoRemainingEnergy_ecal_preselection  ("Remaining_Visible_Energy_ecal_preselection ", "Remaining_Visible_Energy; E_{remaining visible} (GeV)", 1500, 0, 3000);
	TH1F histoCandidateEnergy_ecal_preselection  ("CandidateE_ecal_preselection ", "CandidateE; E_{#gamma#gamma} (GeV)",1500, 0, 1500);
	TH1F histoCanditateTheta_ecal_preselection  ("CandidateTheta_ecal_preselection ", "CandidateTheta; #theta_{H}", 90, 0, 180);
	TH1F histoCandidatePhi_ecal_preselection  ("CandidatePhi_ecal_preselection", "CandidatePhi' #phi_{#gamma}", 50, 0, 3.14);
	TH1F histoPhoton1CandidateTheta_ecal_preselection ("Thetaof1stPhotonofCandidate_ecal", "Thetaof1stPhotonofCandidate_ecal; #theta_{#gamma}", 180, 0, 180 );
	TH1F histoPhoton2CandidateTheta_ecal_preselection ("Thetaof2ndPhotonofCandidate_ecal", "Thetaof2ndPhotonofCandidate_ecal; #theta_{#gamma}", 180, 0, 180 );
	TH1F histoPtof1stPhotonofCandidate_ecal ("Ptof1stPhotonofCandidate_ecal", "Ptof1stPhotonofCandidate; Pt (GeV)", 500, 0, 1000);
	TH1F histoPtof2ndPhotonofCandidate_ecal ("Ptof2ndPhotonofCandidate_ecal", "Ptof1stPhotonofCandidate; Pt (GeV)", 500, 0, 1000);
	TH1F angleBetweenPhotons_ecal ("angle_between_photons_ecal", "angle photon particle", 180, 0, 180);

	//hcall energy preselection
	TH1F histoECall_hcal_preselection ("ECall_hcal_preselection", "ECall; E_{ecal} (GeV)", 3000, 0, 3000);
	TH1F histoHCall_hcal_preselection ("HCall_hcal_preselection", "HCall; E_{hcal} (GeV)", 3000, 0, 3000);
	TH1F histoTotalCall_hcal_preselection  ("EnergyCalorimeter_hcal_preselection ", "EnergyCalorimeter; E_{calorimeter} (GeV)", 300, 0, 3000);
	TH1F histoCallRatio_hcal_preselection  ("calRatio_hcal_preselection ", "calRatio ", 100, 0, 1);
	TH1F histoECallEvt_hcal_preselection  ("ECallEvt_hcal_preselection ", "ECallEvt; E_{ecal} (GeV)", 1500, 0, 3000);
	TH1F histoHCallEvt_hcal_preselection  ("HCallEvt_hcal_preselection ", "HCallEvt; E_{hcal} (GeV)", 1500, 0, 3000);
	TH1F histoTotalCallEvt_hcal_preselection  ("EnergyCalorimeterEvt_hcal_preselection ", "EnergyCalorimeterEvt; E_{calorimeter} (GeV)", 300, 0, 3000);
	TH1F histoCallRatioEvt_hcal_preselection  ("calRatioEvt_hcal_preselection ", "calRatioEvt ", 100, 0, 1);
	TH1F histoCandidateM_hcal_preselection ("CandidateInvariantM_hcal_preselection", "CandidateInvariantM; M_{#gamma#gamma} (GeV)", 1000, 0, 1000);
	TH1F histoCandidatePt_hcal_preselection ("CandidatePt_hcal_preselection", "CandidatePt; Pt_{#gamma#gamma} (GeV)", 1500, 0, 1500);
	TH1F histoRemainingEnergy_hcal_preselection ("Remaining_Visible_Energy_hcal_preselection", "Remaining_Visible_Energy; E_{remaining visible} (GeV)", 1500, 0, 3000);
	TH1F histoCandidateEnergy_hcal_preselection ("CandidateE_hcal_preselection", "CandidateE; E_{#gamma#gamma} (GeV)",1500, 0, 1500);
	TH1F histoCanditateTheta_hcal_preselection ("CandidateTheta_hcal_preselection", "CandidateTheta; #theta_{H}", 90, 0, 180);
	TH1F histoCandidatePhi_hcal_preselection ("CandidatePhi_hcal_preselection", "CandidatePhi' #phi_{#gamma}", 50, 0, 3.14);
	TH1F histoPhoton1CandidateTheta_hcal_preselection ("Thetaof1stPhotonofCandidate_hcal", "Thetaof1stPhotonofCandidate_hcal; #theta_{#gamma}", 180, 0, 180 );
	TH1F histoPhoton2CandidateTheta_hcal_preselection ("Thetaof2ndPhotonofCandidate_hcal", "Thetaof2ndPhotonofCandidate_hcal; #theta_{#gamma}", 180, 0, 180 );
	TH1F histoPtof1stPhotonofCandidate_hcal ("Ptof1stPhotonofCandidate_hcal", "Ptof1stPhotonofCandidate; Pt (GeV)", 500, 0, 1000);
	TH1F histoPtof2ndPhotonofCandidate_hcal ("Ptof2ndPhotonofCandidate_hcal", "Ptof1stPhotonofCandidate; Pt (GeV)", 500, 0, 1000);
	TH1F angleBetweenPhotons_hcal ("angle_between_photons_hcal", "angle photon particle", 180, 0, 180);

	//total cal energy preselection
	TH1F histoECall_tcal_preselection ("ECall_tcal_preselection", "ECall; E_{ecal} (GeV)", 3000, 0, 3000);
	TH1F histoHCall_tcal_preselection ("HCall_tcal_preselection", "HCall; E_{hcal} (GeV)", 3000, 0, 3000);
	TH1F histoTotalCall_tcal_preselection  ("EnergyCalorimeter_tcal_preselection ", "EnergyCalorimeter; E_{calorimeter} (GeV)", 300, 0, 3000);
	TH1F histoCallRatio_tcal_preselection  ("calRatio_tcal_preselection ", "calRatio ", 100, 0, 1);
	TH1F histoECallEvt_tcal_preselection  ("ECallEvt_tcal_preselection ", "ECallEvt; E_{ecal} (GeV)", 1500, 0, 3000);
	TH1F histoHCallEvt_tcal_preselection  ("HCallEvt_tcal_preselection ", "HCallEvt; E_{hcal} (GeV)", 1500, 0, 3000);
	TH1F histoTotalCallEvt_tcal_preselection  ("EnergyCalorimeterEvt_tcal_preselection ", "EnergyCalorimeterEvt; E_{calorimeter} (GeV)", 300, 0, 3000);
	TH1F histoCallRatioEvt_tcal_preselection  ("calRatioEvt_tcal_preselection ", "calRatioEvt ", 100, 0, 1);
	TH1F histoCandidateM_tcal_preselection ("CandidateInvariantM_tcal_preselection", "CandidateInvariantM; M_{#gamma#gamma} (GeV)", 1000, 0, 1000);
	TH1F histoCandidatePt_tcal_preselection ("CandidatePt_tcal_preselection", "CandidatePt; Pt_{#gamma#gamma} (GeV)", 1500, 0, 1500);
	TH1F histoRemainingEnergy_tcal_preselection ("Remaining_Visible_Energy_tcal_preselection", "Remaining_Visible_Energy; E_{remaining visible} (GeV)", 1500, 0, 3000);
	TH1F histoCandidateEnergy_tcal_preselection ("CandidateE_tcal_preselection", "CandidateE; E_{#gamma#gamma} (GeV)",1500, 0, 1500);
	TH1F histoCanditateTheta_tcal_preselection ("CandidateTheta_tcal_preselection", "CandidateTheta; #theta_{H}", 90, 0, 180);
	TH1F histoCandidatePhi_tcal_preselection ("CandidatePhi_tcal_preselection", "CandidatePhi' #phi_{#gamma}", 50, 0, 3.14);
	TH1F histoPhoton1CandidateTheta_tcal_preselection ("Thetaof1stPhotonofCandidate_tcal", "Thetaof1stPhotonofCandidate_hcal; #theta_{#gamma}", 180, 0, 180 );
	TH1F histoPhoton2CandidateTheta_tcal_preselection ("Thetaof2ndPhotonofCandidate_tcal", "Thetaof2ndPhotonofCandidate_hcal; #theta_{#gamma}", 180, 0, 180 );
	TH1F histoPtof1stPhotonofCandidate_tcal ("Ptof1stPhotonofCandidate_tcal", "Ptof1stPhotonofCandidate; Pt (GeV)", 500, 0, 1000);
	TH1F histoPtof2ndPhotonofCandidate_tcal ("Ptof2ndPhotonofCandidate_tcal", "Ptof1stPhotonofCandidate; Pt (GeV)", 500, 0, 1000);
	TH1F angleBetweenPhotons_tcal ("angle_between_photons_tcal", "angle photon particle", 180, 0, 180);
...
//Two photons + invM
	...
	for(UInt_t iJob=nFirstJob; iJob<=nLastJob; iJob++)
	{
		...
		while( (evt = lcReader->readNextEvent()) != 0 /*&& brojac < 1000*/)
		{
					...
					//	histoconeEnergy.Fill(coneEnergy); //histogram koji iscrtava energiju konusa
						...
						if (coneEnergy <= maxConeEnergy )
						{
							...
							*/
								...
								if (temp.Theta()*180/M_PI < 5 || temp.Theta()*180/M_PI > 175 )
								cout << "uglovi su:   "<< temp.Theta()* 180/M_PI<<endl;
			...
			/*	std::vector<EVENT::Cluster*> clustersEvt = (std::vector<EVENT::Cluster*>) recParticle->getClusters();
				//cout<<"rekonstrisana čestica je:"<<recParticle->getType()<<endl;

				 for ( std::vector<EVENT::Cluster*>::const_iterator jCluster=clustersEvt.begin(); jCluster!=clustersEvt.end(); ++jCluster)
				{

				if (*jCluster) {
					ecalEvt += (*jCluster)->getSubdetectorEnergies()[0];
					hcalEvt += (*jCluster)->getSubdetectorEnergies()[1];
				}

				 }
				 totalCalEvt=ecalEvt + hcalEvt;*/
		...
		//	cout << "photon size is: " << photons.size()<<endl;
			...
			if (photons.size() == photonSize )
			{
				...
				{
					double ecal = photonsECal[i];
					double hcal = photonsHCal[i];
					histoECall_pt_preselection.Fill(ecal);
					histoHCall_pt_preselection.Fill(hcal);
				...
				vl.EcallEnergy = ecal;
				vl.HcallEnergy = hcal;
				vl.TotalcallEnergy = totalCal;
				 calRatio = ecal/totalCal;
				 histoCallRatio.Fill(calRatio);



				histoECallEvt_def_candidate.Fill(ecal);
				histoHCallEvt_def_candidate.Fill(hcal);
				histoECall_def_2photons.Fill(ecalPht);
				histoHCall_def_2photons.Fill(hcalPht);
				histoTotalCall_def_2photons.Fill(totalCal);
				histoTotalCallEvt_def.Fill(totalCalEvt);*/
				...
				/*    histoECall_photons_preselection.Fill(ecal);
				    histoHCall_photons_preselection.Fill(hcal);
				    histoTotalCall_photons_preselection.Fill(totalCal);
				    histoECallEvt_photons_preselection.Fill(ecalEvt);
				    histoHCallEvt_photons_preselection.Fill(hcalEvt);
				    histoTotalCallEvt_photons_preselection.Fill(totalCalEvt);*/
				...
				/*    if (minhiggsInvM<higgsInvM && higgsInvM<maxhiggsInvM)
				    ...
				    if (cutEhiggsMin < Ehiggs && Ehiggs < cutEhiggsMax)
				    {
					    ...
					    histoTotalCallEvt_photonsEnergy_preselection.Fill(totalCalEvt);
						 ...
						 histoECall.Fill(ecal);
						 histoHCall.Fill(hcal);

			 			 histoTotalCall.Fill(totalCal);

						 histoECallEvt.Fill(ecalEvt);
						 histoHCallEvt.Fill(hcalEvt);
						 calRatioEvt = ecalEvt/totalCalEvt;
						 histoCallRatioEvt.Fill(calRatioEvt);
			 			 histoTotalCallEvt.Fill(totalCalEvt);*
				...
				/*	if (ecal<500)
					{
						numCutEvents_ecal++;
						 ...
						 histoECall_ecal_preselection.Fill(ecal);
						 histoHCall_ecal_preselection.Fill(hcal);
						 calRatio_ecal_preselection = ecal/totalCal;
						 histoCallRatio_ecal_preselection.Fill(calRatio_ecal_preselection);
						 histoTotalCall_ecal_preselection.Fill(totalCal);

						 histoECallEvt_ecal_preselection.Fill(ecalEvt);
						 histoHCallEvt_ecal_preselection.Fill(hcalEvt);
						 calRatioEvt_ecal_preselection = ecalEvt/totalCalEvt;
						 histoCallRatioEvt_ecal_preselection.Fill(calRatioEvt_ecal_preselection);
						 histoTotalCallEvt_ecal_preselection.Fill(totalCalEvt);

						histoPtof1stPhotonofCandidate_ecal.Fill(pt1);
						histoPtof2ndPhotonofCandidate_ecal.Fill(pt2);
						histoPhoton1CandidateTheta_ecal_preselection.Fill(candidate->Photon1.Theta()*180/M_PI);
						histoPhoton1CandidateTheta_ecal_preselection.Fill(candidate->Photon2.Theta()*180/M_PI);
						//histoPhi_ecal_preselection.Fill(candidate->Photon1.Phi());
						//histoPhi_ecal_preselection.Fill(candidate->Photon2.Phi());
						histoCandidatePt_ecal_preselection.Fill(higgs.Pt());
						histoCandidateM_ecal_preselection.Fill(higgs.M());
						histoCandidateEnergy_ecal_preselection.Fill(higgs.Energy());
						histoCanditateTheta_ecal_preselection.Fill(higgs.Theta()*180/M_PI);
						histoCandidatePhi_ecal_preselection.Fill(higgs.Phi());
						histoRemainingEnergy_ecal_preselection.Fill(Eremaining) ;
						angleBetweenPhotons_ecal.Fill(angle_Between_Photons);
					...
					if(hcal<20)
					{
						numCutEvents_hcal++;
						 ...
						 histoECall_hcal_preselection.Fill(ecal);
						 histoHCall_hcal_preselection.Fill(hcal);
						 calRatio_hcal_preselection = ecal/totalCal;
						 histoCallRatio_hcal_preselection.Fill(calRatio_hcal_preselection);
						 histoTotalCall_hcal_preselection.Fill(totalCal);

						 histoECallEvt_hcal_preselection.Fill(ecalEvt);
						 histoHCallEvt_hcal_preselection.Fill(hcalEvt);
						 calRatioEvt_hcal_preselection = ecalEvt/totalCalEvt;
						 histoCallRatioEvt_hcal_preselection.Fill(calRatioEvt_hcal_preselection);
						 histoTotalCallEvt_hcal_preselection.Fill(totalCalEvt);

						histoPtof1stPhotonofCandidate_hcal.Fill(pt1);
						histoPtof2ndPhotonofCandidate_hcal.Fill(pt2);
						histoPhoton1CandidateTheta_hcal_preselection.Fill(candidate->Photon1.Theta()*180/M_PI);
						histoPhoton2CandidateTheta_hcal_preselection.Fill(candidate->Photon2.Theta()*180/M_PI);
						//histoPhi_ecal_preselection.Fill(candidate->Photon1.Phi());
						//histoPhi_ecal_preselection.Fill(candidate->Photon2.Phi());
						histoCandidatePt_hcal_preselection.Fill(higgs.Pt());
						histoCandidateM_hcal_preselection.Fill(higgs.M());
						histoCandidateEnergy_hcal_preselection.Fill(higgs.Energy());
						histoCanditateTheta_hcal_preselection.Fill(higgs.Theta()*180/M_PI);
						histoCandidatePhi_hcal_preselection.Fill(higgs.Phi());
						histoRemainingEnergy_hcal_preselection.Fill(Eremaining) ;
						angleBetweenPhotons_hcal.Fill(angle_Between_Photons);
					...
					{
						numCutEvents_tcal++;
						 calRatio_tcal_preselection = ecal/totalCal;

						 histoECall_tcal_preselection.Fill(ecal);
						 histoHCall_tcal_preselection.Fill(hcal);
						 histoCallRatio_tcal_preselection.Fill(calRatio_tcal_preselection);
						 histoTotalCall_tcal_preselection.Fill(totalCal);

						 histoECallEvt_tcal_preselection.Fill(ecalEvt);
						 histoHCallEvt_tcal_preselection.Fill(hcalEvt);
						 calRatioEvt_tcal_preselection = ecalEvt/totalCalEvt;

						 histoCallRatioEvt_tcal_preselection.Fill(calRatioEvt_tcal_preselection);
						 histoTotalCallEvt_tcal_preselection.Fill(totalCalEvt);

						histoPtof1stPhotonofCandidate_tcal.Fill(pt1);
						histoPtof2ndPhotonofCandidate_tcal.Fill(pt2);
						histoPhoton1CandidateTheta_tcal_preselection.Fill(candidate->Photon1.Theta()*180/M_PI);
						histoPhoton2CandidateTheta_tcal_preselection.Fill(candidate->Photon2.Theta()*180/M_PI);
						//histoPhi_ecal_preselection.Fill(candidate->Photon1.Phi());
						//histoPhi_ecal_preselection.Fill(candidate->Photon2.Phi());
						histoCandidatePt_tcal_preselection.Fill(higgs.Pt());
						histoCandidateM_tcal_preselection.Fill(higgs.M());
						histoCandidateEnergy_tcal_preselection.Fill(higgs.Energy());
						histoCanditateTheta_tcal_preselection.Fill(higgs.Theta()*180/M_PI);
						histoCandidatePhi_tcal_preselection.Fill(higgs.Phi());
						histoRemainingEnergy_tcal_preselection.Fill(Eremaining) ;
						angleBetweenPhotons_tcal.Fill(angle_Between_Photons);
	...
	//ecall
	/*histoCallRatio_ecal_preselection.Write();
	histoECallEvt_ecal_preselection.Write();
	histoHCallEvt_ecal_preselection.Write();
	histoECall_ecal_preselection.Write();
	histoHCall_ecal_preselection.Write();
	histoCallRatioEvt_ecal_preselection.Write();
	histoTotalCallEvt_ecal_preselection.Write();
	histoTotalCall_ecal_preselection.Write();
	histoCandidatePt_ecal_preselection.Write();
	histoCandidateM_ecal_preselection.Write();
	histoCandidateEnergy_ecal_preselection.Write();
	histoCanditateTheta_hcal_preselection.Write();
	histoCandidatePhi_ecal_preselection.Write();
	histoPhoton1CandidateTheta_ecal_preselection.Write();
	histoPhoton2CandidateTheta_ecal_preselection.Write();
	histoPtof1stPhotonofCandidate_ecal.Write();
	histoPtof1stPhotonofCandidate_ecal.Write();
	angleBetweenPhotons_ecal.Write();
	//hcall
	histoCallRatio_hcal_preselection.Write();
	histoECallEvt_hcal_preselection.Write();
	histoHCallEvt_hcal_preselection.Write();
	histoECall_hcal_preselection.Write();
	histoHCall_hcal_preselection.Write();
	histoCallRatioEvt_hcal_preselection.Write();
	histoTotalCallEvt_hcal_preselection.Write();
	histoTotalCall_hcal_preselection.Write();
	histoCandidatePt_hcal_preselection.Write();
	histoCandidateM_hcal_preselection.Write();
	histoCandidateEnergy_hcal_preselection.Write();
	histoCanditateTheta_hcal_preselection.Write() ;
	histoCandidatePhi_hcal_preselection.Write();
	histoPhoton1CandidateTheta_hcal_preselection.Write();
	histoPhoton2CandidateTheta_hcal_preselection.Write();
	histoPtof1stPhotonofCandidate_hcal.Write();
	histoPtof2ndPhotonofCandidate_hcal.Write();
	angleBetweenPhotons_hcal.Write();
	//tcall
	histoCallRatio_tcal_preselection.Write();
	histoECallEvt_tcal_preselection.Write();
	histoHCallEvt_tcal_preselection.Write();
	histoECall_tcal_preselection.Write();
	histoHCall_tcal_preselection.Write();
	histoCallRatioEvt_tcal_preselection.Write();
	histoTotalCallEvt_tcal_preselection.Write();
	histoTotalCall_tcal_preselection.Write();
	histoCandidatePt_tcal_preselection.Write();
	histoCandidateM_tcal_preselection.Write();
	histoCandidateEnergy_tcal_preselection.Write();
	histoCanditateTheta_tcal_preselection.Write() ;
	histoCandidatePhi_tcal_preselection.Write();
	histoPhoton1CandidateTheta_tcal_preselection.Write();
	histoPhoton2CandidateTheta_tcal_preselection.Write();
	histoPtof1stPhotonofCandidate_tcal.Write();
	histoPtof2ndPhotonofCandidate_tcal.Write();
	angleBetweenPhotons_tcal.Write();*/
	//two Photons
	histoECall_photons_preselection.Write();
	histoHCall_photons_preselection.Write();
	histoTotalCall_photons_preselection.Write();
	//TwoPhotons + invM
	histoECall_photonsInvM_preselection.Write();
	histoHCall_photonsInvM_preselection.Write();
	histoTotalCall_photonsInvM_preselection.Write();
	//TwoPhotons + candidate E
	histoECall_photonsEnergy_preselection.Write();
	histoHCall_photonsEnergy_preselection.Write();
	histoTotalCall_photonsEnergy_preselection.Write();

	//Photons from events with pt >10 GeV
	histoECall_pt_preselection.Write();
	histoHCall_pt_preselection.Write();
	histoECallEvt_pt_preselection.Write();
	histoHCallEvt_pt_preselection.Write();
	histoTotalCallEvt_pt_preselection.Write();
	histoTotalCall_pt_preselection.Write();
	histoECall_test.Write();
	histoECall_def_2photons.Write();
	histoHCall_def_2photons.Write();
	histoECallEvt_def_candidate.Write();
	histoHCallEvt_def_candidate.Write();
	histoTotalCall_def_2photons.Write();
	histoTotalCallEvt_def.Write();
